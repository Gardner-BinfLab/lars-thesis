...
The motif discovery pipeline also recovered a motif redundant with the one previously dubbed TRIT in chapter 4 and \textcite{Gardner2011a}. The enrichment analysis I performed indicated that rather than being restricted to the Mycobacteria as we previously hypothesized, this element appears to occur throughout the Actinobacteria. 
