...
Despite these potential problems, when taken in aggregate, we can observe a clear signal from the termination activity of canonical RITs (see figure \ref{fig:can_expr}).
