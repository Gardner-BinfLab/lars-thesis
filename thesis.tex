...
\else
  \author{Lars Barquist}
  \collegeordept{Wellcome Trust Sanger Institute}
  \university{University of Cambridge}
% insert below the file name that contains the crest in-place of 'UnivShield'
...
\include{PublishedWork/published}
...
\renewcommand{\bibname}{References} % changes default name Bibliography to Referencse
\singlespace
\printbibliography
\end{document}
